...
# - Estrutura do DNA e da cromatina - Parte 4
# https://youtu.be/OYAPlnJfepw

# - Replicação do DNA - Parte 1
# https://youtu.be/jxO6D8eC9JQ

# - Estrutura do RNA transcrição e processamento do RNA - Parte 2
# https://youtu.be/w1bS7iCOJQA
...
max_workers_transcribe = psutil.cpu_count(
    logical=False)  # Number of physical cores
...
async def download_audio(video):
    ...
    # counter = 1
    audio_dir = 'code/downloaded_audio'
        ...
        try:
            async with download_semaphore:
                ...
                if audio_path and audio_filename:
                    audio_file_size_mb = os.path.getsize(
                        audio_path) / (1024 * 1024)
...
if __name__ == '__main__':
    ...
    asyncio.run(process_video_or_playlist(url_to_process,
                max_simultaneous_youtube_downloads, max_workers_transcribe))
